...
export const holidays = new Map([
  // 2025年法定节假日
  ['2026-01-01', HOLIDAY.NEW_YEARS_DAY],
  ['2026-02-17', HOLIDAY.SPRING_FESTIVAL],
  ['2026-04-04', HOLIDAY.TOMB_SWEEPING_DAY],
  ['2026-05-01', HOLIDAY.LABOUR_DAY],
  ['2026-06-19', HOLIDAY.DRAGON_BOAT_FESTIVAL],
  ['2026-09-25', HOLIDAY.MID_AUTUMN_FESTIVAL],
  ['2026-10-01', HOLIDAY.NATIONAL_DAY],
]);
...
export const restDays = new Map([
  ...
  ['2026-01-01', HOLIDAY.NEW_YEARS_DAY],
  ['2026-01-02', HOLIDAY.NEW_YEARS_DAY],
  ['2026-01-03', HOLIDAY.NEW_YEARS_DAY],
  ['2026-02-15', HOLIDAY.SPRING_FESTIVAL],
  ['2026-02-16', HOLIDAY.SPRING_FESTIVAL],
  ['2026-02-17', HOLIDAY.SPRING_FESTIVAL],
  ['2026-02-18', HOLIDAY.SPRING_FESTIVAL],
  ['2026-02-19', HOLIDAY.SPRING_FESTIVAL],
  ['2026-02-20', HOLIDAY.SPRING_FESTIVAL],
  ['2026-02-21', HOLIDAY.SPRING_FESTIVAL],
  ['2026-02-22', HOLIDAY.SPRING_FESTIVAL],
  ['2026-02-23', HOLIDAY.SPRING_FESTIVAL],
  ['2026-04-04', HOLIDAY.TOMB_SWEEPING_DAY],
  ['2026-04-05', HOLIDAY.TOMB_SWEEPING_DAY],
  ['2026-04-06', HOLIDAY.TOMB_SWEEPING_DAY],
  ['2026-05-01', HOLIDAY.LABOUR_DAY],
  ['2026-05-02', HOLIDAY.LABOUR_DAY],
  ['2026-05-03', HOLIDAY.LABOUR_DAY],
  ['2026-05-04', HOLIDAY.LABOUR_DAY],
  ['2026-05-05', HOLIDAY.LABOUR_DAY],
  ['2026-06-19', HOLIDAY.DRAGON_BOAT_FESTIVAL],
  ['2026-06-20', HOLIDAY.DRAGON_BOAT_FESTIVAL],
  ['2026-06-21', HOLIDAY.DRAGON_BOAT_FESTIVAL],
  ['2026-09-25', HOLIDAY.MID_AUTUMN_FESTIVAL],
  ['2026-09-26', HOLIDAY.MID_AUTUMN_FESTIVAL],
  ['2026-09-27', HOLIDAY.MID_AUTUMN_FESTIVAL],
  ['2026-10-01', HOLIDAY.NATIONAL_DAY],
  ['2026-10-02', HOLIDAY.NATIONAL_DAY],
  ['2026-10-03', HOLIDAY.NATIONAL_DAY],
  ['2026-10-04', HOLIDAY.NATIONAL_DAY],
  ['2026-10-05', HOLIDAY.NATIONAL_DAY],
  ['2026-10-06', HOLIDAY.NATIONAL_DAY],
  ['2026-10-07', HOLIDAY.NATIONAL_DAY],
]);
...
export const workdays = new Map([
  ...
  ['2026-01-04', HOLIDAY.NEW_YEARS_DAY],
  ['2026-02-14', HOLIDAY.SPRING_FESTIVAL],
  ['2026-02-28', HOLIDAY.SPRING_FESTIVAL],
  ['2026-05-09', HOLIDAY.LABOUR_DAY],
  ['2026-09-20', HOLIDAY.NATIONAL_DAY],
  ['2026-10-10', HOLIDAY.NATIONAL_DAY],
]);
