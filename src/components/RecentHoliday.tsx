...
const RecentHoliday = () => {
  ...
  return (
    <div className='flex items-center justify-between px-3 py-2 bg-slate-100 md:px-6 md:py-4'>
      <div className='flex items-center w-full text-xs text-gray-700 md:text-sm'>
        距离
      ...
      <button
        className='flex items-center justify-center w-6 h-6 transition-all duration-200 bg-white border border-transparent rounded cursor-pointer md:rounded-lg md:h-8 md:w-8 hover:border-gray-600'
